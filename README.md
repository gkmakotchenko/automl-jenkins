...
* С проваленным пайплайном и соответсвующим статусом рядом с коммитом, при нажатии на который можно перейти в ваш Jenkins с более детальной информацией о сборке.
